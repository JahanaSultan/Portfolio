  ...
  return (
    ...
    <section className="aboutme padding-x" id='aboutme'>
        ...
        <div className="content">
            <div className="left">
                <p>I am a full stack web developer and I live in Baku. I spend my days in many different areas of web development from back-end programming (Django/Python) to front-end engineering (HTML, CSS, jQuery/Javascript, React), digital accessibility, user experience, and visual design . I'm extremely passionate about web development and design in all its forms and helping small businesses and artisans build and improve their online presence.</p>
